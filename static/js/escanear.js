document.addEventListener("DOMContentLoaded", () => {
    ...
    const modalOverlay = document.getElementById("atlas-modal-overlay");
    const modalIcon = document.getElementById("atlas-modal-icon");
    const modalTitle = document.getElementById("atlas-modal-title");
    const modalText = document.getElementById("atlas-modal-text");
    const modalPoints = document.getElementById("atlas-modal-points");
    const modalPointsValue = document.getElementById("atlas-modal-points-value");
    const modalComprobante = document.getElementById("atlas-modal-comprobante");
    const modalCompNum = document.getElementById("atlas-modal-comp-num");
    const modalBtn = document.getElementById("atlas-modal-btn");
    ...
    function showModal(config) {
        ...
        modalIcon.className = "atlas-modal-icon " + (config.type || "success");
        ...
        modalBtn.className = "atlas-modal-btn" + (config.type === "error" ? " error-btn" : "");
    ...
    recycleButton.addEventListener("click", async function() {
        ...
        try {
            ...
            await showModal({
                ...
                text: "Tu botella fue registrada correctamente y los AtlasPuntos fueron asignados a tu cuenta.",
